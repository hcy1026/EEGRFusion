    ...
    for epoch in range(config.epochs):
        ...
        if (epoch + 1) % 5 == 0:
            ...
            if config.insubject == True:
                ...
                os.makedirs(
                    f"/home/diaoyueqin/hcy/Retrieval/models/contrast/{config.encoder_type}/mamba_token/{sub}/{current_time}",
                    exist_ok=True)
                file_path = f"/home/diaoyueqin/hcy/Retrieval/models/contrast/{config.encoder_type}/mamba_token/{sub}/{current_time}/{epoch + 1}.pth"
                ...
                os.makedirs(
                    f"/home/diaoyueqin/hcy/Retrieval/models/contrast/across/{config.encoder_type}/mamba_token/{current_time}",
                    exist_ok=True)
                file_path = f"/home/diaoyueqin/hcy/Retrieval/models/contrast/across/{config.encoder_type}/mamba_token/{current_time}/{epoch + 1}.pth"
                torch.save(eeg_model.state_dict(), file_path)
...
def main():
    ...
    parser.add_argument('--data_path', type=str, default="/home/diaoyueqin/hcy/Preprocessed_data_250Hz",
    ...
    parser.add_argument('--output_dir', type=str, default='/home/diaoyueqin/hcy/Retrieval/outputs/contrast',
    ...
    parser.add_argument('--lr', type=float, default=1e-4, help='Learning rate')  # lr 从 3e-4 到 1e-4
    ...
    for sub in subjects:
        ...
        print(f"Backbone(mamba2)  : {backbone_params} ({format_millions(backbone_params)})")
        print("======================================\n")

        # save to output directory (same as csv)
        param_save_dir = os.path.join(args.output_dir, args.encoder_type, "mamba_token", sub, current_time)
        ...
        with open(param_file, "w") as f:
            ...
            f.write(f"Backbone(mamba2) : {backbone_params} ({format_millions(backbone_params)})\n")
